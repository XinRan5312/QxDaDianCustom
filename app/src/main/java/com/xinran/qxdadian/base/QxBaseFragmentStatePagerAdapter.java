 ...
 */
public  class QxBaseFragmentStatePagerAdapter<E extends Fragment> extends FragmentStatePagerAdapter {

    private int cur = -1;
    private List<E> mList;

    public QxBaseFragmentStatePagerAdapter(FragmentManager fm, List<E> list) {
        super(fm);
        this.mList = list;
    }
